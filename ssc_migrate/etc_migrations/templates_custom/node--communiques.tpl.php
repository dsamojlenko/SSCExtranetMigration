...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div<?php print $content_attributes; ?>>
	...
	<?php $lnkSrc -> '/fr/rss/communiques-fra';
		if($language->language == 'en') { 
			$lnkSrc -> '/en/rss/communiques-eng';
		}
	?>
	<a href="<?php print $lnkSrc; ?>"><img src="/sites/default/files/media/default_images/sl_rss.png" alt="RSS" style="float:right;"></a>
			
	
    <?php print 'test'; print render($content); ?>
  </div>

...
?>
<style>
    #galleria{ width: 700px; height: 400px; background: #000; margin: 
0px auto; }
</style>
<article id="node-<?php print $node->nid; ?>" class="<?php 
...
<script>
Galleria.loadTheme('/profiles/wetkit/themes/wetkit_adaptivetheme/scripts/galleria/themes/classic/galleria.classic.min.js');
